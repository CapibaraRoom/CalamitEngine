...
**Важно!** Проект не подходит для создания классических GUI-приложений. Он не использует системные API (WinAPI, GTK, Qt). Данный проект не подойдет для тесной интеграции в систему.
